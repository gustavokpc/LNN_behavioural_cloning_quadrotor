...
Generated from: conv_cfc_default_n64_epoch=17_val_loss=0.000326.ckpt
Model kind: cfc_default
Input order: dx, dy, dz, vx, vy, vz, phi, theta, psi, p, q, r, Mx_ext, My_ext, Mz_ext, omega1, omega2, omega3, omega4, dt
*/
...
extern const float input_norm_min[20];
extern const float input_norm_max[20];

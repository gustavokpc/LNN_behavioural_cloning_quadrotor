...
def parse_args(argv: Iterable[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--checkpoint",
        type=Path,
        default=PROJECT / "checkpoints" / "BBP1_NOISE_conv_cfc_default_n64_bebop1_epoch=19_val_loss=0.000149.ckpt",
    )
    parser.add_argument(
        "--config",
        type=Path,
        default=PROJECT / "configs" / "conv_BBP1_NOISE_cfc_default_n64_bebop1_epoch=19_val_loss=0.000149.yaml",
    )

...
This export implements the deterministic actor from the SB3 Figure-8 Gates RecurrentPPO CFC policy.
...
```bash
.venv/bin/python LNN_behavioural_cloning_quadrotor/C_codes/FIGURE8_GATES_RECURRENT_PPO/compare_python_c.py
```

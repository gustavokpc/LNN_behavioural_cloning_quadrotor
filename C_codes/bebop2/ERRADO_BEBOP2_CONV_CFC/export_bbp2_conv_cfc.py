...
def parse_args(argv: Iterable[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--checkpoint",
        type=Path,
        default=PROJECT / "checkpoints" / "bebop2" / "bbp2_conv_cfc_default_n64_epoch=19_val_loss=0.000143.ckpt",
    )
    parser.add_argument(
        "--config",
        type=Path,
        default=PROJECT / "configs" / "bebop2" / "bbp2_conv_cfc_default_n64_epoch=19_val_loss=0.000143.yaml",
    )

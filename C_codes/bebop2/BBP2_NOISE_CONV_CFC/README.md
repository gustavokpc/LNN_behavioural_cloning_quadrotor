# BBP2_NOISE_CONV_CFC C Export

Checkpoint: `BBP2_NOISE_conv_cfc_default_n64_epoch=19_val_loss=0.000142.ckpt`
...
Input normalization uses the `bebop2_tau_0_06` profile in `utils/normalization_limits.py`.
...
.venv/bin/python -m LNN_behavioural_cloning_quadrotor.simulators.Simulator_gazebo_square_C \
  --model-config LNN_behavioural_cloning_quadrotor/configs/BBP2_NOISE_conv_cfc_default_n64_epoch=19_val_loss=0.000142.yaml \
  --c-model-dir LNN_behavioural_cloning_quadrotor/C_codes/BBP2_NOISE_CONV_CFC \

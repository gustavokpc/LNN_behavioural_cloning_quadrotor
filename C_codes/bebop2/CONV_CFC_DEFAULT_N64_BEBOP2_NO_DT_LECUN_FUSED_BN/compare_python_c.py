...
CHECKPOINT = PROJECT / "checkpoints" / "bebop2" / "conv_cfc_default_n64_bebop2_no_dt_lecun.ckpt"
CONFIG = PROJECT / "configs" / "bebop2" / "conv_cfc_default_n64_bebop2_no_dt_lecun.yaml"
LIBRARY = C_DIR / "libcontroller_no_dt.so"

...
CHECKPOINT = (
    PROJECT
    / "rl/checkpoints/figure8_gates/recurrent_ppo_models/"
    "recurrent_ppo_figure8_gates_83200000_steps.zip"
)
...
def main() -> None:
    library = HERE / "librl_cfc_83200000.so"
    subprocess.run(
        [
    ...
    rng = np.random.default_rng(83200000)

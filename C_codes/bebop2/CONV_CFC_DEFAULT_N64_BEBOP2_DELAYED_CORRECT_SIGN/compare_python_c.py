...
CHECKPOINT = PROJECT / "checkpoints" / "bebop2" / "conv_cfc_default_n64_bebop2_delayed_correct_sign.ckpt"
CONFIG = PROJECT / "configs" / "bebop2" / "conv_cfc_default_n64_bebop2_delayed_correct_sign.yaml"
LIBRARY = Path("/tmp/libcontroller_bebop2_delayed_correct_sign.so")

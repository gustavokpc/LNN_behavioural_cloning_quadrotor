...
Generated from: conv_ltc_n64_bebop2_baseline_correct_sign_no_dt.ckpt
...
LTC timespan: implicit elapsed_time=1.0, matching training without dt
*/
...
#define LTC_USES_RUNTIME_TIMESPAN 0
#define LTC_DEFAULT_TIMESPAN 1.0f

# BBP1_NOISE_CONV_CFC C Export

Checkpoint: `BBP1_NOISE_conv_cfc_default_n64_bebop1_epoch=19_val_loss=0.000149.ckpt`
...
Input normalization uses `utils/normalization_limits.py`.
...
.venv/bin/python -m LNN_behavioural_cloning_quadrotor.simulators.Simulator_gazebo_square_C \
  --model-config LNN_behavioural_cloning_quadrotor/configs/conv_BBP1_NOISE_cfc_default_n64_bebop1_epoch=19_val_loss=0.000149.yaml \
  --c-model-dir LNN_behavioural_cloning_quadrotor/C_codes/BBP1_NOISE_CONV_CFC \

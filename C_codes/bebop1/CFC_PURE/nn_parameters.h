...
Generated from: new_CFC_pure_64_neurons_seq_1_epoch=17_val_loss=0.000203.ckpt
Model kind: cfc_pure
...
extern const float rnn_rnn_cell_w_tau[64];
extern const float rnn_rnn_cell_A[64];

...
from LNN_behavioural_cloning_quadrotor.utils.normalization_limits_bebop2 import GLOBAL_MAX, GLOBAL_MIN
...
def parse_args(argv: Iterable[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--checkpoint",
        type=Path,
        default=PROJECT / "checkpoints" / "BBP2_NOISE_conv_cfc_default_n64_epoch=19_val_loss=0.000142.ckpt",
    )
    parser.add_argument(
        "--config",
        type=Path,
        default=PROJECT / "configs" / "BBP2_NOISE_conv_cfc_default_n64_epoch=19_val_loss=0.000142.yaml",
    )

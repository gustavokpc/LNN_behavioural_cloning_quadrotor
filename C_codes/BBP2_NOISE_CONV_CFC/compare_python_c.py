...
from utils.normalization_limits_bebop2 import GLOBAL_MAX, GLOBAL_MIN
from utils.quadrotor_sim import build_lightning_model, make_model_observation

MODEL_NAME = "BBP2_NOISE_conv_cfc_default_n64_epoch=19_val_loss=0.000142.ckpt"
CONFIG_PATH = PROJECT / "configs" / "BBP2_NOISE_conv_cfc_default_n64_epoch=19_val_loss=0.000142.yaml"
STATE = np.array(
    [
        0.3,
        -0.2,
